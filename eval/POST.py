...
def postProcess(xFoilResults, flagPlot, AoAR, Vinf):
    ...
    # Returns (SPVP CL, K-J lift eq. CL, XFOIL CL), XFOIL CD, (SPVP CM, XFOIL CM)
    # return (CL, (2*sum(gamma*S)), xFoilCL), xFoilCD, (CM, xFoilCM)
    return (0,0, xFoilCL), xFoilCD, (0, 0)